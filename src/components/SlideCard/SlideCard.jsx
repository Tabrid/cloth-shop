...
const SlideCard = () => {
    ...
    return (
        <div
            className={`w-[80%] md:w-[40%] bg-base-100 shadow-2xl h-fit z-[999] p-6 fixed top-0 ${slideCard
                ? "right-0 transition-right duration-500 "
                : "hidden right-[-620px] transition-left duration-500"
                }`}
        >
            ...
            <div className="grid md:grid-cols-4 gap-6 relative">
                ...
                <div className="col-span-2">
                    ...
                    <div className="flex border w-20 my-5 py-2 px-2 rounded-md">
                        <button className="" onClick={decreaseNumber}>
                            <HiOutlineMinus />
                        </button>
                        <input
                            type="text"
                        ...
                        />
                        <button className="" onClick={increaseNumber}>
                            <BsPlusLg />
                        </button>
                    </div>
                </div>
