...
const SlideCard = () => {
    ...
    return (
        <div className={`w-[80%] md:w-[40%] bg-base-100 shadow-2xl h-fit z-[99999] p-6 fixed top-0 ${slideCard ? 'right-0 transition-right duration-500 ' : 'hidden right-[-620px] transition-left duration-500'}`}>
