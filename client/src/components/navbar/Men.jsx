...
const Men = () => {
    return (
        <div className="w-full h-fit border-t border-slate-300">
            <div className="grid grid-cols-5  gap-4">
                ...
                <div>
                    <img src="https://thegivingmovement.com/cdn/shop/files/AIR_LOUNGE_MENS_FEATURED_1_220x.jpg?v=1713023571" alt=""  />
